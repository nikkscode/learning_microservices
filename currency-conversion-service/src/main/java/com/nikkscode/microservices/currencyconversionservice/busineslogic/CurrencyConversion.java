...
public class CurrencyConversion {
    ...
    public CurrencyConversion(Long id, String from, String to, BigDecimal quantity, BigDecimal conversionMultiple, BigDecimal totalCaculatedAmount, String environment) {
        this.id = id;
        this.from = from;
        this.to = to;
